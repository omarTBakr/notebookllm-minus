...
`src/arabic_extraction/benchmark/reports/FINDINGS.md` has the full ten-engine comparison, and
`src/arabic_extraction/benchmark/colab/qari_server.ipynb` is the *other* Qari notebook — that one serves
