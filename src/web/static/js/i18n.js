...
const STRINGS = {
  en: {
    ...
    mapCollapse: "Exit full screen",
    mapHint: "Drag to move · Ctrl + scroll to zoom",
    mapClose: "Close",
    reports: "Reports",
  ...
  ar: {
    ...
    mapZoomOut: "تصغير",
    mapFit: "ملاءمة العرض",
    mapExpand: "ملء الشاشة",
    mapCollapse: "الخروج من ملء الشاشة",
    mapHint: "اسحب للتحريك · Ctrl مع التمرير للتكبير",
    mapClose: "إغلاق",
    reports: "تقارير",
    flashcards: "بطاقات",
    quiz: "اختبار",
