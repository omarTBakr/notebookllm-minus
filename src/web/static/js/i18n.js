...
const STRINGS = {
  en: {
    ...
    // Deliberately says the set is still filling rather than showing a
    // percentage: the total is not known until the last chunk is read.
    backToStudio: "Studio",
    studioStillAdding: "still adding…",
    studioWorking: "reading the documents…",
    studioNothingYet: "Nothing was generated from these documents.",
    studioAlreadyRunning: "Already generating — it will keep filling.",
  ...
  ar: {
    ...
    next: "التالي",
    flip: "اقلب",
    regenerate: "وَلِّد من جديد",
    flashcardFront: "السؤال",
    flashcardBack: "الإجابة",
    backToStudio: "الاستوديو",
    studioStillAdding: "ما زال يُضاف…",
    studioWorking: "جارٍ قراءة المستندات…",
    studioNothingYet: "لم يُولَّد شيء من هذه المستندات.",
    studioAlreadyRunning: "التوليد جارٍ بالفعل، وسيستمر في الإضافة.",
    studioFailed: "تعذّر التوليد.",
